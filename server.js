...
db.serialize(() => {
  ...
  db.run(`CREATE TABLE IF NOT EXISTS Tasks (
    ...
    status TEXT,
    assignee_id INTEGER,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,-- Default timestamp for created_at
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,-- Default timestamp for updated_at
